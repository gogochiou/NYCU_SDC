...
def main() -> None:
    ...
    parser.add_argument("--out_dir", type=str, default="data/FusionTrack_results")
    ...
    '''Fusion Param Start'''
    parser.add_argument("--Tracking2", type=str, help="file which contains the tracklets to fuse with")
    ...
    parser.add_argument("--fusion_del_th", type=float, default=0.0)
    ###
    ...
    for i in tqdm(range(len_frames)):
        ...
        if frames[i]['first']:
            ...
            fusion.update_scene_velos(detections, frames, i)
